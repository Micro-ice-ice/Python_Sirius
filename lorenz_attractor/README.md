...
# Задание 8: Анимация аттрактора Лоренца

В задании 6 необходимо добавить отрисовку (анимацию при помощи библиотеки `matplotlib` или другой аналогичной) поведения нескольких решений атрактора. Анимация должна происходить при запуске программы и не останавливаться пока пользователь не закроет окно. В окне анимации необходимо создать 4 графика:
* проекция решений на плоскость `x-y`
* проекция решений на плоскость `x-z`
* отрисовка решений как функций времени `x(t), y(t), z(t)`
* трёхмерный график в координатах `x,y,z`